export function createTraceMetadata(input = {}) {
  return {
...
export function createEventEnvelope(name, payload, input = {}) {
  return {
...
export function createErrorEvent(error, input = {}) {
...
export function redactSecrets(payload, keys = ["password", "token", "secret", "authorization"]) {
